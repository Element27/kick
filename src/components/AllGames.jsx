...
export default function AllGames() {
  ...
  return (
    <div className='text-white gap-4 py-4 w-full mx-auto'>
        ...
        section.map((item) => (
          <div key={item.id} className='my-4 w-full'>
            <div className='flex items-center justify-between w-11/12 mx-auto my-4'>
              ...
              <button className='text-[10px] cursor-pointer hover:scale-105 transition-transform duration-200 ease-in-out hover:border-b hover:border-b-[#EA3D17] px-2 py-1'>View All</button>
            </div>
